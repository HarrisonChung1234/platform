...
// Module
exports.push([module.i, ".annotation{cursor:move;border:1px solid #3e3e3e;background:rgba(0,0,0,.3)}.selected{background:rgba(89,190,244,.3)}.hidden{display:none}.resize-dot{position:absolute;width:8px;height:8px;border-radius:50%;background:#fff;box-sizing:border-box}.resize-dot-n{cursor:n-resize;top:-4px}.resize-dot-n,.resize-dot-s{position:absolute;left:50%;margin-left:-4px}.resize-dot-s{cursor:s-resize;bottom:-4px}.resize-dot-w{cursor:w-resize;left:-4px}.resize-dot-e,.resize-dot-w{position:absolute;top:50%;margin-top:-4px}.resize-dot-e{cursor:e-resize;right:-4px}.resize-dot-nw{cursor:nw-resize;margin-left:-4px}.resize-dot-ne,.resize-dot-nw{position:absolute;margin-top:-4px}.resize-dot-ne{cursor:ne-resize;right:0;margin-right:-4px}.resize-dot-sw{position:absolute;cursor:sw-resize;bottom:0;margin-left:-4px;margin-bottom:-4px}.resize-dot-se{cursor:se-resize;right:-4px;bottom:0;margin-bottom:-4px}.g-image-op{bottom:0;cursor:auto;position:absolute}.g-image-op-content{background-color:hsla(0,0%,100%,.6);box-sizing:border-box;height:30px;line-height:30px;padding:0 10px;white-space:nowrap}.g-image-op-del{cursor:pointer}@media screen and (max-width:768px){.g-handler-touchable .resize-dot-e:after,.g-handler-touchable .resize-dot-n:after,.g-handler-touchable .resize-dot-ne:after,.g-handler-touchable .resize-dot-nw:after,.g-handler-touchable .resize-dot-s:after,.g-handler-touchable .resize-dot-se:after,.g-handler-touchable .resize-dot-sw:after,.g-handler-touchable .resize-dot-w:after{content:\"\";position:absolute;top:0;bottom:0;right:0;left:0;display:inline-block;width:auto;height:auto;background-color:rgba(0,0,0,.2)}.g-handler-touchable .resize-dot{position:absolute;width:auto;height:auto;min-width:12px;min-height:12px;border-radius:2px;background:#fff;box-sizing:border-box}.g-handler-touchable .resize-dot-n{position:absolute;cursor:n-resize;height:12px;top:-6px;left:40%;right:40%}.g-handler-touchable .resize-dot-n:after{line-height:12px;border-top:5px dotted #fff;border-bottom:5px dotted #fff}.g-handler-touchable .resize-dot-s{position:absolute;cursor:s-resize;height:12px;bottom:-6px;left:40%;right:40%}.g-handler-touchable .resize-dot-s:after{line-height:12px;border-top:5px dotted #fff;border-bottom:5px dotted #fff}.g-handler-touchable .resize-dot-w{position:absolute;cursor:w-resize;width:12px;left:-6px;top:40%;bottom:40%}.g-handler-touchable .resize-dot-w:after{line-height:12px;border-left:5px dotted #fff;border-right:5px dotted #fff}.g-handler-touchable .resize-dot-e{position:absolute;cursor:e-resize;width:12px;right:-6px;top:40%;bottom:40%}.g-handler-touchable .resize-dot-e:after{line-height:12px;border-left:5px dotted #fff;border-right:5px dotted #fff}.g-handler-touchable .resize-dot-ne:after,.g-handler-touchable .resize-dot-nw:after,.g-handler-touchable .resize-dot-se:after,.g-handler-touchable .resize-dot-sw:after{line-height:12px;border-top:5px dotted #fff;border-bottom:5px dotted #fff}.g-handler-touchable .resize-dot-nw{position:absolute;cursor:nw-resize;width:12px;height:12px;margin-top:-6px;margin-left:-6px}.g-handler-touchable .resize-dot-ne{position:absolute;cursor:ne-resize;right:0;width:12px;height:12px;margin-top:-6px;margin-right:-6px}.g-handler-touchable .resize-dot-sw{position:absolute;cursor:sw-resize;bottom:0;width:12px;height:12px;margin-left:-6px;margin-bottom:-6px}.g-handler-touchable .resize-dot-se{position:absolute;cursor:se-resize;bottom:0;width:12px;height:12px;right:0;margin-bottom:-6px;margin-right:-6px}.g-handler-touchable .g-image-op-content{line-height:20px;height:20px}.g-handler-touchable .g-image-op-content .g-image-op-name{font-size:12px}}", ""]);
// Exports
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".vmr-ai-panel[data-v-630b5554]{background:#3e3e3e;width:100%;display:flex;flex-direction:row;align-items:center;height:auto}.vmr-ai-panel .vmr-ai-raw-image[data-v-630b5554],.vmr-ai-panel .vmr-ai-raw-image-mask[data-v-630b5554],.vmr-ai-panel .vmr-g-image[data-v-630b5554]{width:100%;height:100%}", ""]);
// Exports
module.exports = exports;
...
__webpack_require__("94e1");

var _config = __webpack_require__("8912");

var _anno = _interopRequireDefault(__webpack_require__("c0eb"));

var _movement = _interopRequireDefault(__webpack_require__("adaf"));
...
// load the styles
var content = __webpack_require__("2e09");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("31109b50", content, true, {"sourceMap":false,"shadowMode":false});
...
// load the styles
var content = __webpack_require__("018d");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("4c4570b2", content, true, {"sourceMap":false,"shadowMode":false});
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_630b5554_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("6898");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_630b5554_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_630b5554_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
...
module.exports =__webpack_require__("5b06");
...
__webpack_require__.d(__webpack_exports__, "AIMarker", function() { return /* reexport */ components_marker; });
__webpack_require__.d(__webpack_exports__, "PictureMarker", function() { return /* reexport */ marker_PictureMarker; });
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"60546589-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/lib/components/marker/index.vue?vue&type=template&id=630b5554&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vmr-ai-panel",class:_vm.rootClass,attrs:{"loading":_vm.loading}},[_c('div',{staticClass:"vmr-g-image",staticStyle:{"position":"relative","overflow":"hidden"}},[_c('img',{staticClass:"vmr-ai-raw-image",staticStyle:{"display":"block","position":"absolute","user-select":"none"},attrs:{"src":_vm.currentBaseImage},on:{"load":_vm.onImageLoad}}),_vm._m(0)])])}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"annotate vmr-ai-raw-image-mask",staticStyle:{"user-select":"none","position":"absolute","cursor":"crosshair","left":"0px","top":"0"}},[_c('div',{staticClass:"draft",staticStyle:{"position":"absolute","user-select":"none","display":"none","background-color":"rgba(1,0,0,0.5)"}})])}]


// CONCATENATED MODULE: ./src/lib/components/marker/index.vue?vue&type=template&id=630b5554&scoped=true&
...
// EXTERNAL MODULE: ./node_modules/ui-picture-bd-marker/index.js
var ui_picture_bd_marker = __webpack_require__("f5d5");

// CONCATENATED MODULE: ./src/lib/components/marker/js/marker.js
...
var marker_PictureMarker = function PictureMarker(_parentEl, _draftEl, _configs) {
  var _this = this;

  _classCallCheck(this, PictureMarker);

  _defineProperty(this, "_makeMarker", function (parentEl, draftEl, configs) {
    return new ui_picture_bd_marker["BdAIMarker"](parentEl, draftEl, null, configs);
  });

  _defineProperty(this, "updateConfig", function (configs) {
    _this.marker.setConfigOptions(configs);
  });

  _defineProperty(this, "getMarker", function () {
    return _this.marker;
  });

  _defineProperty(this, "setTag", function () {
    var tag = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _this.marker.setTag(tag);
  });

  _defineProperty(this, "renderData", function (data, wihe) {
  ...
  _defineProperty(this, "mapDataPercent2Real", function (dataArray, baseW, baseH) {
    return dataArray.map(function (item) {
      item.position = Object(ui_picture_bd_marker["positionP2S"])(item.position, baseW, baseH);
      return item;
    });
  });
...
// EXTERNAL MODULE: ./node_modules/ui-picture-bd-marker/styles/bdmarker.scss
var bdmarker = __webpack_require__("6f5d");

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/lib/components/marker/index.vue?vue&type=script&lang=js&
...
/* harmony default export */ var markervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    __updateFrame: function __updateFrame() {
      ...
      root.querySelectorAll(".vmr-g-image,.vmr-ai-raw-image,.vmr-ai-raw-image-mask").forEach(function (element) {
        ...
        if (_this.wratioh == 0) {
          ...
          element.style.height = parseInt(root.clientWidth) / _this.wratioh + "px";
        }
      });
    ...
    __initMarker: function __initMarker() {
      ...
      self.marker = new marker_PictureMarker(root.querySelector(".annotate"), //box
  ...
  watch: {
    ...
    readOnly: function readOnly(n, o) {
      this.options.options = _objectSpread2(_objectSpread2({}, this.options.options), {}, {
        editable: !n
      });
...
// CONCATENATED MODULE: ./src/lib/components/marker/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_markervue_type_script_lang_js_ = (markervue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/lib/components/marker/index.vue?vue&type=style&index=0&id=630b5554&lang=scss&scoped=true&
var markervue_type_style_index_0_id_630b5554_lang_scss_scoped_true_ = __webpack_require__("736d");
...
// CONCATENATED MODULE: ./src/lib/components/marker/index.vue
...
// CONCATENATED MODULE: ./src/lib/components/marker/index.js



marker.install = function (Vue) {
  return Vue.component(marker.name, marker);
};
...
var components = [components_marker];
